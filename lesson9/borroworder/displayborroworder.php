...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            <a href="#" onclick="confirmDelete('<?php echo $order['transaction_id']; ?>')">Delete</a>
        </td>
    </tr>
    <?php endforeach; ?>
</table>
...
function confirmDelete(transactionId) {
    if (confirm('Bạn có chắc chắn muốn xóa trường có ID ' + transactionId + ' không?')) {
        window.location.href = 'deleteborroworder.php?id=' + transactionId;
    }
}
</script>